/**
 * Upload the extracted Home page media to Cloudinary, grouped under
 * `climate facility/home-page/`, and write each returned secure_url back into
 * cms/seed-manifests/home-page/manifest.json.
 *
 *   node scripts/upload-home-media.mjs
 *
...
import { PAGE_NAME, CLOUDINARY_FOLDER } from './home-media-sources.mjs';
